...
<?php echo $this->BcForm->create('AdminMakeResponsive', array('url' => array('controller' => 'admin_make_responsive','action' => 'index'))) ?>
...
<table cellpadding="0" cellspacing="0" id="AdminMakeResponsiveTable" class="form-table bca-form-table">
	<tr>
		...
		<td class="col-input bca-form-table__input">
			<?php echo $this->BcForm->input('AdminMakeResponsive.flg_enable', array('type' => 'checkbox', 'label' => '有効にする', 'value' => '1')) ?>
